function display2_1() {
  var myanswer  = "The first log statement will print 'undefined' because that trait is not defined in the object. The second statement will print True, because the JS type system evaluates Null and Undefined to be the same, just like it evaluates an empty string to be false. However, Null === undefined is False because '===' is strict equality, so the type system does not automatically case between different types." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "Strict mode requires declaring variables. The provided code will fail because x is not declared. To fix, simply declare x, 'var x = 3.14'" // TODO 2.2: Fill in Answer here
